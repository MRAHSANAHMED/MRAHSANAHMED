...
//   print_r($_POST);  
//   echo "</pre>";
$post_category_id = $_POST['cat_title'];
...
if (isset($_GET['edit'])){
    ...
    $post_query = "UPDATE posts set 
            post_title='$post_title' , post_author = '$post_author', post_status = '$post_status', cat_title = '$post_category_id' , post_image ='$post_image' where post_id = '$post_id'";
}else{
    $post_query ="INSERT INTO posts (`post_title`,`cat_title`,`post_author`,`post_status`,`post_image`) 
...
<?php if($result->num_rows > 0): ?>
    <?php while($row = mysqli_fetch_assoc($result)){ ?>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'];?>?edit=<?php echo $post_id;?>?>" method="POST" role="form">
            ...
            <input type="text" name="cat_title" class="form-control" id="" value="<?php echo $row['cat_title']; ?>" placeholder="Category">
...
<!-- insert form -->
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" role="form">
            ...
            <input type="text" name="cat_title" class="form-control" id="" placeholder="Category">
