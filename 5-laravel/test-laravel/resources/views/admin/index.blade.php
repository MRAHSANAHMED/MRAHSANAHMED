                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Light Logo icon -->
                            <img src="asset/asset-admin/images/logo-light-icon.png" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text --><span>
                            <!-- dark Logo text -->
                            ...
                            <!-- Light Logo text -->
                            <img src="asset/asset-admin/images/logo-light-text.png" class="light-logo" alt="homepage" /></span>
                    </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="asset/asset-admin/images/users/1.jpg" alt="user" class="img-circle" width="30"></a>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->
                        <!-- ============================================================== -->
                                ...
                                <div class="steamline m-t-40">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user"
                                                src="asset/asset-admin/images/users/1.jpg"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user"
                                                src="asset/asset-admin/images/users/2.jpg"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user"
                                                src="asset/asset-admin/images/users/3.jpg"> </div>
                                        <div class="sl-right">
                            ...
                            <div class="card-body">
                                ...
                                <div class="message-box">
                                    <div class="message-widget message-scroll">
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="asset/asset-admin/images/users/1.jpg" alt="user"
                                        ...
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="asset/asset-admin/images/users/2.jpg" alt="user"
                                                    class="img-circle"> <span
                                        ...
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="asset/asset-admin/images/users/4.jpg" alt="user"
                                                    class="img-circle"> <span
